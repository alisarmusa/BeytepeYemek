...
<head>
    <meta charset="utf-8" />
    <title>@yield('title') | BeytepeYemek.com</title>
...
<body background="{{ asset('images/admin.jpg') }}">
<section class="vbox">
    <header class="bg-dark dk header navbar navbar-fixed-top-xs">
        <div class="navbar-header aside-md">
            ...
            <a href="#" class="navbar-brand" style="color: #fb6b5b; font-weight: 200" data-toggle="fullscreen">MAEOS <span style="font-size: 15px; color: rgb(101, 189, 119); font-weight: 900">KEOPS</span></a>
            <a class="btn btn-link visible-xs" data-toggle="dropdown" data-target=".nav-user">
                <i class="fa fa-cog"></i>
            </a>
        </div>
        <ul class="nav navbar-nav navbar-right m-n hidden-xs nav-user">
            <li class="hidden-xs"><a href="#" class="dropdown-toggle"> <b>BeytepeYemek.com</b></a></li>
            <li class="dropdown">
                            ...
                            <nav class="nav-primary hidden-xs">
                                <ul class="nav">
                                        ...
                                        <ul class="nav lt">
                                            <li >
                                                <a href="{{ route('scoreboard.index') }}" >
                                                    <i class="fa fa-angle-right"></i>
                                                    <span>All My Favourites</span>
                                                </a>
                                            </li>
                                            <li >
                                                <a href="{{ route('scoreboard.create') }}" >
                                                    <i class="fa fa-angle-right"></i>
                                    ...
                                    <li >
                                        ...
                                        <ul class="nav lt">
                                            <li >
                                                <a href="{{ route('order.index') }}" >
                                                    <i class="fa fa-angle-right"></i>
                                                    <span>Show Your Scoreboard</span>
                                                </a>
                                            </li>
                                    ...
                                    <li >
                                        ...
                                        <ul class="nav lt">
                                            <li >
                                                <a href="{{ route('recentmovements.index') }}" >
                                                    <i class="fa fa-angle-right"></i>
                                                    <span>All Recent Movements</span>
                                                </a>
                                            </li>
                                            <li >
                                                <a href="{{ route('recentmovements.create') }}" >
                                                    <i class="fa fa-angle-right"></i>
                                                    <span>Add Recent Movements</span>
                                                </a>
                                            </li>
                                        </ul>
                                    </li>
                            ...
                            <section class="dropdown-menu on aside-md m-l-n">
                                <section class="panel bg-white">
                                    ...
                                    <div class="panel-body animated fadeInRight">
                                        <p class="text-sm">Copyright © {{ date("Y") }} <b>MAEOS KEOPS</b></p>
                                        <p>BY <strong><span style="color: green">ALISAR</span><span style="color:red"> SANCAR</span></strong></p>
                                    </div>
                                </section>
                            </section>
                        </div>
